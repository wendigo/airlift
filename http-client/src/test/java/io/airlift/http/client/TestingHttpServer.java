        ...
        implements AutoCloseable
{
    ...
    public TestingHttpServer(boolean http2, Optional<String> keystore, Servlet servlet)
            throws Exception
    {
        this(http2, keystore, servlet, httpConfiguration -> {}, Optional.empty());
    }

    public TestingHttpServer(boolean http2, Optional<String> keystore, Servlet servlet, Consumer<HttpConfiguration> configurationDecorator, Optional<Handler.Wrapper> additionalHandle)
            throws Exception
    {
        ...
        if (keystore.isPresent()) {
            ...
            connector = new ServerConnector(server, getSecureProtocols(sslContextFactory, httpConfiguration, http2));
        }
        else {
    ...
    private static ConnectionFactory[] getSecureProtocols(SslContextFactory.Server sslContext, HttpConfiguration configuration, boolean enableHttp2)
    {
        ...
        return new ConnectionFactory[] {new SslConnectionFactory(sslContext, alpn.getProtocol()), alpn, http11};
    }
